...
const SECTIONS: {
...
}[] = [
  {
    kind: "brand",
    title: "Brands & makers",
    note: "Guitar and amp brands, pedal builders, synth makers, record labels.",
    hint: "e.g. Fender, Boss, Moog",
    suggestions: [
      "Fender",
      "Gibson",
      "Gretsch",
  ...
  },
  {
    ...
    title: "Budgets by type",
    note: "Set a ceiling per instrument type so the agent flags what's in range.",
    hint: "instrument type",
    suggestions: [
      "Electric Guitars",
      "Bass Guitars",
      "Acoustic Guitars",
  ...
  },
  {
    kind: "color",
    title: "Finishes",
    note: "Finishes you gravitate toward - matched against each listing's finish.",
    hint: "e.g. sunburst, natural, relic",
    suggestions: [
      "Sunburst",
      "Natural",
      "Black",
  ...
  },
  {
    kind: "size",
    title: "Setup",
    note: "Optional details the agent keeps in mind when it advises you.",
    hint: "e.g. left-handed",
    suggestions: [
      "Right-handed",
      "Left-handed",
      "6-string",
