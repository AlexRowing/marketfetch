...
const SECTIONS: {
...
}[] = [
  {
    kind: "brand",
    title: "Brands",
    note: "Labels and makers you look for across the marketplace.",
    hint: "e.g. Carhartt, Nike, Levi's",
    suggestions: [
      "Carhartt",
      "Levi's",
      "Nike",
  ...
  },
  {
    kind: "color",
    title: "Colours",
    note: "Colours you gravitate toward - matched against each listing's colour.",
    hint: "e.g. black, navy, brown",
    suggestions: [
      "black",
      "navy",
      "brown",
  ...
  },
  {
    kind: "size",
    title: "Sizes",
    note: "Your clothing and shoe sizes, so the agent can flag what actually fits.",
    hint: "e.g. M, W32 L32, 42",
    suggestions: ["XS", "S", "M", "L", "XL", "W30 L32", "W32 L32", "W34 L32", "41", "42", "43"],
  },
];
