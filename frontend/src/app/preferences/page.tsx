      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-10">
        <header className="mb-8 border-b border-line pb-6">
          ...
          <p className="mt-3 max-w-xl text-[15px] leading-relaxed text-ink-muted">
            What the agent knows about you - the brands you follow, your sizes and
            colours, and your budget per category. Everything here shapes your feed
            and its advice; items marked with a spark were learned from your
            activity.
          </p>
        </header>
